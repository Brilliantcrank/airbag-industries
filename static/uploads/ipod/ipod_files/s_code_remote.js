...
var s_linkDownloadFileTypes="exe,zip,wav,mp3,mp4,mov,mpg,avi,doc,pdf,xls,rss,dmg,sit,mpkg,pkg,bin,hqx"

var s_linkLeaveQueryString=false
var s_linkTrackVars="s_prop3"
...
+k.length,e<0?c.length:e));return v!='[[B]]'?v:''}function s_c_w(k,v,e){var d=
...
s_d.cookie=k+'='+s_ape(v!=''?v:'[[B]]')+'; path=/;'+(e&&l!='SESSION'?' expires='
...
)+'://metrics.apple.com/b/ss/'+un+'/1/G.6-Pd-R/'
